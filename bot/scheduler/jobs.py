    ...
    try:
        async with async_session() as session:
            ...
            for chat_id in target_ids:
                ...
                session.add(log)
                # SIDE EFFECT: Dispatches message to Telegram chat. Why necessary and unavoidable: Core functionality to deliver scheduled content to the intended audience.
                try:
            ...
            # SIDE EFFECT: Updates item publication status in database. Why necessary and unavoidable: Required to track successful delivery and prevent double-publication of one-shot items.
            try:
